...
def check_arg(args=None):
    ...
    parser.add_argument('-ni', '--iterations', help='Number of iterations', dest="number_of_iterations", default=2000, metavar="<integer>", type=int)
    parser.add_argument('-t', '--num_words', help='Number of most probable topical words', dest="number_of_top_words", default=20, metavar="<integer>", type=int)
